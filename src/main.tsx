...
// Define global if it's not defined, and handle fetch read-only property
if (typeof (window as any).global === 'undefined') {
  (window as any).global = new Proxy(window, {
    set(target, prop, value) {
      if (prop === 'fetch' && 'fetch' in target) {
        // Ignore setting fetch if it already exists as a read-only property
        return true;
      }
